...
public class RandomService {
    ...
    public interface AsyncIface {
        ...
        public void roll(Range range, org.apache.thrift.async.AsyncMethodCallback<RandomNumberStruct> resultHandler)
        ...
        public static class roll_call extends org.apache.thrift.async.TAsyncMethodCall<RandomNumberStruct> {
            ...
            public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
                prot.writeMessageBegin(
                        new org.apache.thrift.protocol.TMessage("roll", org.apache.thrift.protocol.TMessageType.CALL,
                                0));
                roll_args args = new roll_args();
                args.setRange(range);
                args.write(prot);
    ...
    public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I>
        ...
        public Processor(I iface) {
            super(iface, getProcessMap(
                    new java.util.HashMap<String, org.apache.thrift.ProcessFunction<I, ?
                            extends org.apache.thrift.TBase, ? extends org.apache.thrift.TBase>>()));
        }

        protected Processor(I iface,
                java.util.Map<String, org.apache.thrift.ProcessFunction<I, ? extends org.apache.thrift.TBase, ?
                        extends org.apache.thrift.TBase>> processMap) {
            super(iface, getProcessMap(processMap));
        }

        private static <I extends Iface> java.util.Map<String, org.apache.thrift.ProcessFunction<I, ?
                extends org.apache.thrift.TBase, ? extends org.apache.thrift.TBase>> getProcessMap(
                java.util.Map<String, org.apache.thrift.ProcessFunction<I, ? extends org.apache.thrift.TBase, ?
                        extends org.apache.thrift.TBase>> processMap) {
    ...
    public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
        ...
        public AsyncProcessor(I iface) {
            super(iface, getProcessMap(
                    new java.util.HashMap<String, org.apache.thrift.AsyncProcessFunction<I, ?
                            extends org.apache.thrift.TBase, ?, ? extends org.apache.thrift.TBase>>()));
        }

        protected AsyncProcessor(I iface,
                java.util.Map<String, org.apache.thrift.AsyncProcessFunction<I, ? extends org.apache.thrift.TBase, ?,
                        ? extends org.apache.thrift.TBase>> processMap) {
            super(iface, getProcessMap(processMap));
        }

        private static <I extends AsyncIface> java.util.Map<String, org.apache.thrift.AsyncProcessFunction<I, ?
                extends org.apache.thrift.TBase, ?, ? extends org.apache.thrift.TBase>> getProcessMap(
                java.util.Map<String, org.apache.thrift.AsyncProcessFunction<I, ? extends org.apache.thrift.TBase, ?,
                        ? extends org.apache.thrift.TBase>> processMap) {
            processMap.put("roll", new roll());
        ...
        public static class roll<I extends AsyncIface>
                extends org.apache.thrift.AsyncProcessFunction<I, roll_args, RandomNumberStruct, roll_result> {
            public roll() {
                super("roll");
            }
            ...
            @Override
            public org.apache.thrift.async.AsyncMethodCallback<RandomNumberStruct> getResultHandler(
            ...
            @Override
            public void start(I iface, roll_args args,
                    org.apache.thrift.async.AsyncMethodCallback<RandomNumberStruct> resultHandler)
                    throws org.apache.thrift.TException {
    ...
    @SuppressWarnings({ "cast", "rawtypes", "serial", "unchecked", "unused" })
    public static class roll_args
            implements org.apache.thrift.TBase<roll_args, roll_args._Fields>, java.io.Serializable, Cloneable,
            Comparable<roll_args> {
        private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
                "roll_args");

        private static final org.apache.thrift.protocol.TField RANGE_FIELD_DESC = new org.apache.thrift.protocol.TField(
                "range", org.apache.thrift.protocol.TType.STRUCT, (short) 1);

        private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY =
                new roll_argsStandardSchemeFactory();
        private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY =
                new roll_argsTupleSchemeFactory();
        ...
        static {
            java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new java.util.EnumMap<_Fields,
                    ...
                    _Fields.class);
            tmpMap.put(_Fields.RANGE, new org.apache.thrift.meta_data.FieldMetaData("range",
        ...
        public int compareTo(roll_args other) {
            ...
            lastComparison = Boolean.compare(isSetRange(), other.isSetRange());
            if (lastComparison != 0) {
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder("roll_args(");
            boolean first = true;
        ...
        private static class roll_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<roll_args> {
            ...
            @Override
            public void read(org.apache.thrift.protocol.TProtocol iprot, roll_args struct)
                    throws org.apache.thrift.TException {
            ...
            @Override
            public void write(org.apache.thrift.protocol.TProtocol oprot, roll_args struct)
                    throws org.apache.thrift.TException {
                struct.validate();
        ...
        private static class roll_argsTupleScheme extends org.apache.thrift.scheme.TupleScheme<roll_args> {
            ...
            @Override
            public void write(org.apache.thrift.protocol.TProtocol prot, roll_args struct)
                    throws org.apache.thrift.TException {
            ...
            @Override
            public void read(org.apache.thrift.protocol.TProtocol prot, roll_args struct)
                    throws org.apache.thrift.TException {
    ...
    @SuppressWarnings({ "cast", "rawtypes", "serial", "unchecked", "unused" })
    public static class roll_result
            implements org.apache.thrift.TBase<roll_result, roll_result._Fields>, java.io.Serializable, Cloneable,
            Comparable<roll_result> {
        private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
                "roll_result");
        ...
        private static final org.apache.thrift.protocol.TField INVALID_RANDOM_RANGE_FIELD_DESC =
                new org.apache.thrift.protocol.TField(
                "invalidRandomRange", org.apache.thrift.protocol.TType.STRUCT, (short) 1);

        private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY =
                new roll_resultStandardSchemeFactory();
        private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY =
                new roll_resultTupleSchemeFactory();
        ...
        static {
            ...
            tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success",
                    org.apache.thrift.TFieldRequirementType.DEFAULT,
                    new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT,
                            RandomNumberStruct.class)));
            tmpMap.put(_Fields.INVALID_RANDOM_RANGE, new org.apache.thrift.meta_data.FieldMetaData("invalidRandomRange",
                    org.apache.thrift.TFieldRequirementType.DEFAULT,
                    new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT,
                            InvalidRandomRange.class)));
            metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
        ...
        public roll_result setInvalidRandomRange(
                @org.apache.thrift.annotation.Nullable InvalidRandomRange invalidRandomRange) {
            this.invalidRandomRange = invalidRandomRange;
            return this;
        }
        ...
        public int compareTo(roll_result other) {
            ...
            lastComparison = Boolean.compare(isSetInvalidRandomRange(), other.isSetInvalidRandomRange());
            if (lastComparison != 0) {
                return lastComparison;
            }
            if (isSetInvalidRandomRange()) {
                lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.invalidRandomRange,
                        other.invalidRandomRange);
                if (lastComparison != 0) {
                    return lastComparison;
                }
            }
        ...
        @Override
        public String toString() {
            StringBuilder sb = new StringBuilder("roll_result(");
            boolean first = true;
        ...
        private static class roll_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<roll_result> {
            ...
            @Override
            public void read(org.apache.thrift.protocol.TProtocol iprot, roll_result struct)
                    throws org.apache.thrift.TException {
                org.apache.thrift.protocol.TField schemeField;
                iprot.readStructBegin();
                while (true) {
            ...
            @Override
            public void write(org.apache.thrift.protocol.TProtocol oprot, roll_result struct)
                    throws org.apache.thrift.TException {
                struct.validate();
        ...
        private static class roll_resultTupleScheme extends org.apache.thrift.scheme.TupleScheme<roll_result> {
            ...
            @Override
            public void write(org.apache.thrift.protocol.TProtocol prot, roll_result struct)
                    throws org.apache.thrift.TException {
                org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
                java.util.BitSet optionals = new java.util.BitSet();
            ...
            @Override
            public void read(org.apache.thrift.protocol.TProtocol prot, roll_result struct)
                    throws org.apache.thrift.TException {
                org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
